				...
				<section id="page-content">
					<?php
						...
						if ( is_product() ) {
							...
							$standard_featured_image = false;
						}
					?>
					<?php thb_get_template_part('partial-page-header', array( 'thb_title' => $page_title, 'thb_subtitle' => $page_subtitle, 'standard_featured_image' => $standard_featured_image ) ); ?>
...
if( !function_exists('thb_woo_cart') ) {
	function thb_woo_cart() {
		...
		echo "<div class='thb-mini-cart-icon ". $cart_class ."'>";
			...
			echo "<a href='" . $woocommerce->cart->get_cart_url() . "' id='thb-cart-trigger'>Cart</a>";
