...
<div class="thb-photogallery">
	<?php if ( count( $slides ) > 0 ) : ?>
		<ul id="<?php thb_grid_layout_id(); ?>" class="thb-photogallery-container thb-images-container <?php thb_grid_layout_class( $columns, $gutter, $height ); ?>" <?php thb_data_attributes( $data_attrs ); ?>>
