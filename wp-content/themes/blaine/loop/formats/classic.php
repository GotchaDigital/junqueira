...
<div class="<?php echo $wrapper_classes; ?>">
	...
	<div class="loop-post-content">
		...
		<div id="autorPost">
			<ul>
			<li class="thb-author-avatar"><?php echo get_avatar( get_the_author_meta( 'ID' ) , 48 ); ?></li>
			<li class="thb-author-name"><?php the_author_posts_link(); ?></li>
			<li class="thb-data"><?php the_date('F j, Y'); ?></li>
			<li class="thb-category"><?php $category = get_the_category(); echo 'Em '.$category[0]->cat_name; ?></li>
			<li class="thb-category"><?php thb_comments_number('0'); ?></li>
		</ul>
		</div>
		...
		<a class="thb-btn thb-read-more" href="<?php the_permalink(); ?>">
			<span><?php _e( 'Leia mais', 'thb_text_domain' ); ?></span>
		</a>
