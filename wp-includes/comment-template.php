...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		...
		'comment_notes_beforee' => '<p class="comment-notes"><span id="email-notes">' . __( 'Your email address will not be published.' ) . '</span>'. ( $req ? $required_text : '' ) . '</p>',
		'comment_notes_afterr'  => '<p class="form-allowed-tags" id="form-allowed-tags">' . sprintf( __( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s' ), ' <code>' . allowed_tags() . '</code>' ) . '</p>',
		'id_form'              => 'commentform',
		'id_submit'            => 'submit',
		'class_submit'         => 'submit',
		'name_submit'          => 'submit',
	...
	?>
		<?php if ( comments_open( $post_id ) ) : ?>
			...
			<div id="respond" class="comment-respond">
				<h3 id="reply-title" class="comment-reply-title"><?php echo "Comentários" ?> <small><?php cancel_comment_reply_link( $args['cancel_reply_link'] ); ?></small></h3>
